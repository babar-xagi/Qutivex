...
| Phase 4 | Native Kotlin/JVM build engine; remove Gradle from build/run/test | ⏭️ Next |
| Phase 5 | IDE workflow, daily development, stable 1.0 hardening | ⏳ Planned |
...
- [ ] exclusions
- [ ] optional dependencies
- [ ] correct runtime/test scopes
- [ ] deterministic conflict resolution
- [ ] cycle detection
- [ ] Qutivex-owned artifact cache
- [ ] concurrent download deduplication
- [ ] `qutivex add` is Gradle-free
- [ ] `qutivex remove` is Gradle-free
- [ ] `qutivex install` is Gradle-free
- [ ] dependency `qutivex update` is Gradle-free
- [ ] `qutivex tree` remains Gradle-free
- [ ] `qutivex list` remains Gradle-free
- [ ] offline mode has zero network
- [ ] frozen mode is immutable
- [ ] offline+frozen has zero network and zero Gradle
- [ ] deterministic lockfile
- [ ] SHA-256 integrity preserved
- [ ] existing `run/test/build` still work
- [ ] `qutivex update` self-updates Qutivex
- [ ] MSI self-update verifies SHA-256
- [ ] tests pass
...
# Phase 4 — Native Kotlin/JVM Build Engine ⏳ PLANNED
...
- [ ] build works without Gradle
- [ ] run works without Gradle
- [ ] test works without Gradle
- [ ] compiler managed by Qutivex
- [ ] classpaths generated by Qutivex
- [ ] native JAR packaging
- [ ] no-change builds measured
- [ ] safe build cache
- [ ] normal Kotlin/JVM project no longer requires Gradle
